...
/**
 * "Employee Portal Access" panel shown to SuperAdmin in Employee
 ...
 * SuperAdmin copy or share the portal's login link with the employee.
 */
  ...
  return (
    <section className="detail-section portal-access-section" id="portal-access">
      ...
      <p className="detail-field-value" style={{ textAlign: "left", fontWeight: 400, marginBottom: 12 }}>
        ...
        Portal — a separate login, not part of the SuperAdmin Dashboard.
      </p>
