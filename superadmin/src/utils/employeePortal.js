/**
 * Helpers for the "Employee Portal Access" feature in SuperAdmin →
 * Employee Management. The Employee Portal is a separate app (see
 * `employee/`); SuperAdmin never embeds its login form — it only shares a
 ...
 * to a generic share link where the SuperAdmin picks the contact.
 */
